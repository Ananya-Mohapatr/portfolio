...
const WorkExperience = () => {
  return (
    <div className='absolute justify-center bg-customColor backdrop-filter rounded-lg backdrop-blur-sm opacity-120 text-white  p-10 ml-[10%] mr-[10%] m-[20%] backdrop-filter  lg:flex md:flex  sm:object md:mt-[200%] sm:mt-[265%] lg:mt-[82%] 
